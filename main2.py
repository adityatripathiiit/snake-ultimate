...
mouth.speed(0)
###########################################################################
display.addshape('Images\\snake_mouth2.gif') ########### THIS IS THE ONLY #
turtle.shape('Images\\snake_mouth2.gif')  #####        DIFFERENCE BETWEEN #
mouth.shape('Images\\snake_mouth2.gif')  ####### 'main1.py' AND 'main2.py'#
###########################################################################
#mouth.color("black")
mouth.penup()
mouth.goto(40,0)
...
def move():
    #if mouth.direction =="down" and mouth.direction =="left":
    #    x=mouth.xcor()
     #   y=mouth.ycor()
      #  mouth.setx(x+5)
       # mouth.sety(y+5)
